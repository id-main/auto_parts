...
- (void)viewDidLoad {
    ...
    self.DATEPROFIL = DATEPROFIL;
     NSLog(@"date get_member_profile %@",DATEPROFIL);
    SEGMENTACTIV =0;
...
//        [cell.NUMEPROFIL sizeToFit];
//        CGRect framenecesar = cell.score.frame;
//        framenecesar.origin.x = cell.NUMEPROFIL.frame.origin.x + cell.NUMEPROFIL.frame.size.width +12;
//        cell.score.frame = framenecesar;
       if(DATEPROFIL[@"score"]) scor = [NSString stringWithFormat:@"%@",DATEPROFIL[@"score"]];
        ...
        NSLog(@"classss %@",DATEPROFIL[@"stars_class"]);
//        CGRect framenecesar1 = cell.score.frame;
//        framenecesar1.origin.x = cell.score.frame.origin.x + cell.score.frame.size.width +12;
//        cell.stars_class.frame = framenecesar1;
...
@end
    //    self.titluriCAMPURI =@[@{@"id":@"1",
    //                             @"title": @"Bara spate cu intaritura Bmw 320 facelift 1999 - 2005",
    //                             @"data_ora": @"13 martie ora 15:30",
    //                             @"citita": @"0",
    //                             },
    //                           @{@"id":@"2",
    //                               @"title": @"Alta notificare",
    //                               @"data_ora": @"23 martie ora 12:10",
    //                               @"citita": @"1",
    //                               },
    //                           @{@"id":@"3",
    //                             @"title": @"Cea mai noua notificare",
    //                             @"data_ora": @"09 mai 2016 ora 15:06",
    //                             @"citita": @"0",
    //                             },
    //                           @{@"id":@"3",
    //                             @"title": @"Cea mai noua notificare",
