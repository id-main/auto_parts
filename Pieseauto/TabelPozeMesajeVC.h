//
// TabelPozeMesajeVC.h -> un view cu poze selectate pe cerere
//  Pieseauto
//
...
@interface TabelPozeMesajeVC : UIViewController<UITabBarDelegate,UITableViewDelegate,UITableViewDataSource,UITextViewDelegate,UITextFieldDelegate,UISearchBarDelegate> {
    Utile * utilitar;
}
